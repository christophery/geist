...
if ( ! function_exists( 'geist_setup' ) ) :
	...
	function geist_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'geist_custom_background_args', array(
...
function geist_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'geist_content_width', 640 );
}
 ...
 */
function geist_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'geist' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'geist' ),
...
add_action( 'widgets_init', 'geist_widgets_init' );
...
function geist_scripts() {
	...
	wp_enqueue_script( 'geist-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

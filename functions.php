...
function geist_scripts() {
	...
	wp_enqueue_script( 'geist-main-js', get_template_directory_uri() . '/built/js/main.js', array('jquery'), '20190322', true );

	wp_enqueue_script( 'geist-fitvids-js', get_template_directory_uri() . '/built/js/jquery.fitvids.js', array(), '20190322', true );

	wp_enqueue_script( 'geist-skip-link-focus-fix', get_template_directory_uri() . '/built/js/skip-link-focus-fix.js', array(), '20151215', true );
